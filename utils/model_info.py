...
model_descriptions = {
    "exp31": "(Accuracy@1: 0.712) Предобработка текста: простая. Методы: TF-IDF, косинусное сходство",
    "exp32": "(Accuracy@1: 0.543) Предобработка текста: простая. Методы: BOW, косинусное сходство",
    "exp33": "(Accuracy@1: 0.364) Предобработка текста: простая. Методы: fuzzywuzzy",
